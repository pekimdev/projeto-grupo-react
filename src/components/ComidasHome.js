    ...
    <div>
        ...
        <div className='container w-75'>
            <div className='row text-center my-5'>
                <div className='col'><img src={abara} className='w-100 sombra' alt='Foto de um prato de abará, comida baiana.'/></div>
            ...
            <div className='row text-center my-3'>
                ...
                <div className='col'><img src={caipirinha} className='w-100 sombra' alt='Foto de um prato de abará, comida baiana.'/></div>
            </div>
        </div>
    </div>
)
